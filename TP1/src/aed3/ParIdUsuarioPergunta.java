...
public class ParIdUsuarioPergunta
        implements InterfaceArvoreBMais<ParIdUsuarioPergunta>, Comparable<ParIdUsuarioPergunta> {
    ...
    @Override
    public int compareTo(ParIdUsuarioPergunta obj) {
    ...
    public ParIdUsuarioPergunta clone() {
        return new ParIdUsuarioPergunta(this.idUsuario, this.idPergunta);
    }
