...
public class ArquivoUsuario extends aed3.Arquivo<Usuario> {
    ...
    private HashExtensivel<ParIdEmail> hashEmail;

    public ArquivoUsuario() throws Exception {
        super("Usuario", Usuario.class.getConstructor());
        hashEmail = new HashExtensivel<>(ParIdEmail.class.getConstructor(), 4,
                "./dados/Usuario/indiceEmail.diretorio.db", "./dados/Usuario/indiceEmail.cestos.db");
    }
